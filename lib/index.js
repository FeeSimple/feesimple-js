...
const { 
  checkAccountNameError, mapPropertyToFloorplanList, mapPropertyToUnitList, timestamp2String 
} = require('./helper');
...
FeeSimpleJs.prototype = {
  ...
  getAvailabilityData: async function (accountName) {
    ...
    const propertyToUnitList = mapPropertyToUnitList(unitList, unitImgList);
